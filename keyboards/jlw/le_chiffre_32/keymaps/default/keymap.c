...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_Z,   KC_X,   KC_C, KC_D,   KC_V,                     KC_K,     KC_H,  KC_COMM, KC_DOT, KC_SLSH,
                KC_LSFT,KC_LCTL, MT(MOD_LGUI,KC_ENTER),     LT(1,KC_SPACE), MO(2),   MO(3)
    ),

    [1] = LAYOUT_3thumb(
         XXXXXXX, XXXXXXX, KC_HOME,  KC_END,  XXXXXXX,   KC_MPLY,   KC_PGUP,   S(KC_TAB),    KC_UP,   KC_TAB,   XXXXXXX,
         XXXXXXX, XXXXXXX, KC_BSPC,  KC_ESC,  KC_COLN,              KC_PGDN,   KC_LEFT,      KC_DOWN, KC_RIGHT, KC_ENTER,
         XXXXXXX, XXXXXXX, XXXXXXX,  KC_DEL, XXXXXXX,               LGUI(KC_Z),S(LGUI(KC_Z)),XXXXXXX, XXXXXXX,  XXXXXXX,
                          _______, _______,  _______,               _______, _______, MO(5)
    ),
    /*
     *      1 2 3 4 5   6 7 8 9 0
     *      ~ [ { ( -   + ) } ] |
    ...
    [2] = LAYOUT_3thumb(
         ...
         _______,   KC_GRV, KC_QUOT, S(KC_QUOT), S(KC_MINUS),                KC_EQUAL, KC_COLN, KC_SCLN, KC_DOT,  KC_BSLS,
    ...
    [3] = LAYOUT_3thumb(
        ...
        HYPR(KC_Z), HYPR(KC_X), HYPR(KC_C), HYPR(KC_D), HYPR(KC_V),           HYPR(KC_K), HYPR(KC_H) ,   KC_VOLD,       KC_VOLU,       KC_MPLY,
